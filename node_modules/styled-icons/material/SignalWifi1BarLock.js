...
export const SignalWifi1BarLock = styled(StyledIcon).withConfig({
  displayName: "SignalWifi1BarLock",
  componentId: "ws7gvq-0"
})(["display:inline-block;vertical-align:middle;overflow:hidden;"]);
SignalWifi1BarLock.displayName = 'SignalWifi1BarLock';
export const SignalWifi1BarLockDimensions = {
  height: 24,
  width: 24
};