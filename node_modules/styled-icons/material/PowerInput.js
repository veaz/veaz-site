...
const StyledIcon = React.forwardRef((props, ref) => {
  ...
  return React.createElement("svg", _extends({}, iconProps, svgProps, {
    ...
    key: "PowerInput-title"
  }, title), React.createElement("path", {
    d: "M2 9v2h19V9H2zm0 6h5v-2H2v2zm7 0h5v-2H9v2zm7 0h5v-2h-5v2z",
    key: "k0"
  }));
});
export const PowerInput = styled(StyledIcon).withConfig({
  displayName: "PowerInput",
  componentId: "sc-16u7ens-0"
})(["display:inline-block;vertical-align:middle;overflow:hidden;"]);
PowerInput.displayName = 'PowerInput';
export const PowerInputDimensions = {
  height: 24,
  width: 24
};