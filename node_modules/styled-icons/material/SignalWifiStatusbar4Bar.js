...
const StyledIcon = React.forwardRef((props, ref) => {
  ...
  return React.createElement("svg", _extends({}, iconProps, svgProps, {
    ...
    key: "SignalWifiStatusbar4Bar-title"
  }, title), React.createElement("path", {
    d: "M13.01 21.99L25.58 6.32C25.1 5.96 20.26 2 13 2S.9 5.96.42 6.32l12.57 15.66.01.02.01-.01z",
    key: "k0"
  }));
});
export const SignalWifiStatusbar4Bar = styled(StyledIcon).withConfig({
  displayName: "SignalWifiStatusbar4Bar",
  componentId: "sc-1j8jlh7-0"
})(["display:inline-block;vertical-align:middle;overflow:hidden;"]);
SignalWifiStatusbar4Bar.displayName = 'SignalWifiStatusbar4Bar';
export const SignalWifiStatusbar4BarDimensions = {
  height: 24,
  width: 26
};