...
export const GripLinesVertical = styled(StyledIcon).withConfig({
  displayName: "GripLinesVertical",
  componentId: "sc-1x4p6a7-0"
})(["display:inline-block;vertical-align:-.125em;overflow:hidden;"]);
GripLinesVertical.displayName = 'GripLinesVertical';
export const GripLinesVerticalDimensions = {
  height: undefined,
  width: undefined
};