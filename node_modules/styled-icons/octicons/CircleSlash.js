...
export const CircleSlash = styled(StyledIcon).withConfig({
  displayName: "CircleSlash",
  componentId: "sc-1n1a4jm-0"
})(["display:inline-block;vertical-align:middle;overflow:hidden;"]);
CircleSlash.displayName = 'CircleSlash';
export const CircleSlashDimensions = {
  height: 16,
  width: 14
};