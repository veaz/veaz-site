...
export const FileSymlinkDirectory = styled(StyledIcon).withConfig({
  displayName: "FileSymlinkDirectory",
  componentId: "mhc2nd-0"
})(["display:inline-block;vertical-align:middle;overflow:hidden;"]);
FileSymlinkDirectory.displayName = 'FileSymlinkDirectory';
export const FileSymlinkDirectoryDimensions = {
  height: 16,
  width: 14
};