...
const StyledIcon = React.forwardRef((props, ref) => {
  ...
  return React.createElement("svg", _extends({}, iconProps, svgProps, {
    ...
    key: "MenuAltRight-title"
  }, title), React.createElement("path", {
    d: "M4 6h16v2H4zm4 5h12v2H8zm5 5h7v2h-7z",
    key: "k0"
  }));
});
export const MenuAltRight = styled(StyledIcon).withConfig({
  displayName: "MenuAltRight",
  componentId: "sc-1lqrrmj-0"
})(["display:inline-block;vertical-align:middle;overflow:hidden;"]);
MenuAltRight.displayName = 'MenuAltRight';
export const MenuAltRightDimensions = {
  height: 24,
  width: 24
};