...
const StyledIcon = React.forwardRef((props, ref) => {
  ...
  return React.createElement("svg", _extends({}, iconProps, svgProps, {
    ...
    key: "GridVertical-title"
  }, title), React.createElement("path", {
    d: "M7 10h4v4H7zm0-6h4v4H7zm0 12h4v4H7zm6-6h4v4h-4zm0-6h4v4h-4zm0 12h4v4h-4z",
    key: "k0"
  }));
});
export const GridVertical = styled(StyledIcon).withConfig({
  displayName: "GridVertical",
  componentId: "sc-17mcexn-0"
})(["display:inline-block;vertical-align:middle;overflow:hidden;"]);
GridVertical.displayName = 'GridVertical';
export const GridVerticalDimensions = {
  height: 24,
  width: 24
};